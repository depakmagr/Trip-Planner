...
def travelPlanning_workflow(user_request, season="summer", activity="beach",
    ...
    prompt = f"""
You are a travel expect. The following travel context is given as JSON:

{json.dumps(plan_context, indent=2)}

Using this context, create a detailed, readable travel plan for the user.
Format it like a traevel guide with explations, recommended activities (with keeping in mind about the weather summary) and why the destination was chosen.
