...
OPENTRIPMAP_API_KEY = '5ae2e3f221c38a28845f05b652bf5cfa752a5d855eeea2e3f1aeb403'
WEATHER_API_KEY = '3448009ee8244ccf94d23858251508'
...
def get_destinations(season=None, activity=None):
    ...
    if activity:
        ...
        return ["Paris", "Tokyo", "Barcelona", "Italy"]
